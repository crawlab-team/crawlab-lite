    ...
    >
      <h3 class="title">
        ...
        <span class="logo-sub-title">
          <div class="logo-sub-title-block">Lite</div>
          <div class="logo-sub-title-block">v0.5.0</div>
        </span>
      </h3>
    ...
    const login = async () => {
      ...
      try {
        ...
        initPlugins(router, store)
          ...
          .catch((e) =>
            console.warn('[Crawlab] initializing plugins with error', e),
          )
...
@import 'crawlab-ui/src/styles/variables.scss';
$bg: white;
$dark_gray: #889aa4;
$light_gray: #aaa;
.login-container {
