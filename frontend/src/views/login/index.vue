  ...
  <div class="login-container">
    ...
    >
      ...
      <div class="tips">
        ...
        <a href="https://github.com/crawlab-team/crawlab-lite" target="_blank" style="float:right">
          <img src="https://img.shields.io/github/stars/crawlab-team/crawlab-lite?logo=github">
        </a>
      </div>
      <div class="lang">
      ...
      handleLogin() {
        this.$refs.loginForm.validate(async valid => {
          ...
          if (res.status === 200) {
            ...
            this.$message({
              type: 'error',
              message: `[${res.response.status}] ${res.response.data.message}`,
              customClass: 'message-error'
            })
