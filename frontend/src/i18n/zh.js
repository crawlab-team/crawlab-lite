export default {
  ...
  'Error when logging in (Please read documentation Q&A)':
    '登录时出错（请查看文档 Q&A）',
  ...
  // 其他
  'Star crawlab-team/crawlab-lite on GitHub':
    '在 GitHub 上为 Crawlab Lite 加星吧',
}
