export default {
  ...
  'This action cannot be undone. This will permanently delete the spider and all associated data!': '注意该操作无法撤销，将会删除爬虫及所有的关联数据！',
  'Please type': '请输入',
  'to confirm.': '确认删除',
  'Are you sure to delete this version?': '你确定要删除该版本?',
  'Are you sure to delete this user?': '你确定要删除该用户?',
  'Inconsistent spider name': '爬虫名称不一致',
