export default {
  ...
  'Upload a zip file containing all spider files to create the spider.': '上传一个包含所有爬虫文件的 zip 文件来创建爬虫',
  ...
  'The command which will be used to run the spider program.': '用于启动爬虫的命令',
